...
class Member : IMember
{
    ...
    private string pin;
    private IMovieCollection borrowed;
    ...
    public string Pin { get { return pin; } set { pin = value; } }// Get and set a pin number
                                                                  //public string Borrow { get { return borrow; } set { Borrow = value; } } // Get and set a collection of registered members who are holding this movie
    public IMovieCollection Borrowed { get { return borrowed; } set { borrowed = value; } }
    ...
    public Member(string firstName, string lastName, string contactNumber, string pin, IMovieCollection borrowed)  //string borrow
    {
        this.firstName = firstName;
        this.lastName = lastName;
